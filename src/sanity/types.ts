...
export type AllSanitySchemaTypes = Playlist | Startup | Post | Author | Category | BlockContent | Markdown | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
// Query: *[_type == "author" && githubId == $id][0]{    _id,    githubId,    name,    username,    email,    image,    bio  }
...
// Query: *[_type == "playlist" && slug.current == $slug][0] {    _id,    title,    slug,    "select": select[]-> {      _id,      _createdAt,      author-> {        _id,         name,        username,        image      },      views,      title,      description,      category,      image,      pitch    }  }
